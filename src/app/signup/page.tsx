              ...
              <div>
                ...
                <div className="mt-1 relative">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 pr-10 border border-white/10 rounded-md shadow-sm placeholder-gray-400 bg-black/50 focus:outline-none focus:ring-snookerGreen focus:border-snookerGreen sm:text-sm text-white"
                  />
                  <button
                    type="button"
